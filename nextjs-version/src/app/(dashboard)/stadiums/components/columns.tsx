...
export const columns: ColumnDef<Stadium>[] = [
    ...
    },
    {
        ...
        cell: ({ row }) => {
            ...
            // Check if general discount (from /discounts) is currently active
            ...
            // Show general discount with green color if active
            if (hasActiveDiscount && discount) {
                return (
                    <div className="flex flex-col gap-0.5">
                        ...
                        <span className="text-[9px] font-bold text-green-500/50 uppercase tracking-[0.2em]">umumiy chegirma</span>
                    </div>
                )
            }

            // No general discount - show regular price only
            return (
                <div className="flex flex-col gap-0.5">
